...
//levels
    val levelLayouts = listOf(
        ...
        Level(42, listOf(0,1,2,5,8,10,11,12,15,18,20,21,22,23)),
    ...
    val movementsScoring = listOf(
        MovementsScoring(0,6,12,16),
        MovementsScoring(1,6,12,16),
        MovementsScoring(2,6,12,16),
        MovementsScoring(3,6,12,16),
        MovementsScoring(4,6,12,16),
        MovementsScoring(5,7,12,17),
        MovementsScoring(6,7,13,17),
        MovementsScoring(7,7,13,17),
        MovementsScoring(8,7,13,17),
        MovementsScoring(9,7,13,17),
        MovementsScoring(10,8,14,18),
        MovementsScoring(11,8,14,18),
        MovementsScoring(12,8,14,18),
        MovementsScoring(13,8,14,18),
        MovementsScoring(14,8,14,18),
        MovementsScoring(15,9,15,19),
        MovementsScoring(16,9,15,19),
        MovementsScoring(17,9,15,19),
        MovementsScoring(18,9,15,19),
        MovementsScoring(19,9,15,19),
        MovementsScoring(20,10,16,20),
        MovementsScoring(21,10,16,20),
        MovementsScoring(22,10,16,20),
        MovementsScoring(23,10,16,20),
        MovementsScoring(24,10,16,20),
        MovementsScoring(25,11,17,21),
        MovementsScoring(26,11,17,21),
        MovementsScoring(27,11,17,21),
        MovementsScoring(28,11,17,21),
        MovementsScoring(29,11,17,21),
        MovementsScoring(30,12,18,22),
        MovementsScoring(31,12,18,22),
        MovementsScoring(32,12,18,22),
        MovementsScoring(33,12,18,22),
        MovementsScoring(34,12,18,22),
        MovementsScoring(35,13,19,23),
        MovementsScoring(36,13,19,23),
        MovementsScoring(37,13,19,23),
        MovementsScoring(38,13,19,23),
        MovementsScoring(39,13,19,23),
        MovementsScoring(40,14,20,24),
        MovementsScoring(41,14,20,24),
        MovementsScoring(42,14,20,24),
        MovementsScoring(43,14,20,24),
        MovementsScoring(44,14,20,24),
        MovementsScoring(45,15,21,25),
        MovementsScoring(46,15,21,25),
        MovementsScoring(47,15,21,25),
        MovementsScoring(48,15,21,25),
        MovementsScoring(49,15,21,25),
        MovementsScoring(50,15,21,25)
    )
